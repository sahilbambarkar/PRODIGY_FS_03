...
export const createCheckoutAndGetURL = async ({ uid, products, address }) => {
      ...
      price_data: {
        ...
        product_data: {
          ...
          images: [
            ...
            `${process.env.NEXT_STRIPE_PUBLISHABLE_KEY}/logo.png`,
          ],
          metadata: {
            productId: item?.id,
          },
  ...
  await setDoc(ref, {
    ...
    success_url: `${process.env.NEXT_STRIPE_PUBLISHABLE_KEY}/checkout-success?checkout_id=${checkoutId}`,
    cancel_url: `${process.env.NEXT_STRIPE_PUBLISHABLE_KEY}/checkout-failed?checkout_id=${checkoutId}`,
  });
